...
try {
    ...
    $stmt = $pdo->prepare("
        UPDATE day_exercise 
        SET n_sets = :n_sets, n_reps = :n_reps, time_break = :time_break 
        WHERE id_day = :id_day AND id_exercise = :id_exercise
    ");
    $stmt->execute([
    ...
    echo json_encode(['ok' => false, 'msg' => 'Error al actualizar ejercicio', 'error' => $e->getMessage()]);
}
?>